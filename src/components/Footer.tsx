...
const Footer = () => {
  ...
  return (
    <footer className="bg-background/80 backdrop-blur-sm pt-16 pb-8">
      <div className="container mx-auto px-4">
        <div className="grid grid-cols-1 md:grid-cols-2 lg:grid-cols-4 gap-8 mb-12">
          <div>
            <h3 className="text-xl font-bold mb-4">Ashutosh Saxena</h3>
            <p className="text-gray-400 mb-4">
              A DevOps Engineer specializing in building and optimizing modern infrastructure and deployment pipelines.
            </p>
          ...
          <div>
            ...
            <ul className="space-y-2">
              <li className="text-gray-400">Docker</li>
              <li className="text-gray-400">Kubernetes</li>
              <li className="text-gray-400">Terraform</li>
              <li className="text-gray-400">CI/CD</li>
              <li className="text-gray-400">AWS/Azure</li>
          ...
          <div>
            ...
            <ul className="space-y-2">
              <li>
                <a 
                  href="mailto:ash.191245141@gmail.com" 
        ...
        <motion.div 
          ...
          viewport={{ once: true }}
        >
          <p>&copy; {currentYear} Ashutosh Saxena. All rights reserved.</p>
          <p className="mt-2">Designed and built with Next.js, Tailwind CSS and Framer Motion.</p>
        </motion.div>
      </div>
      ...
      >
        <Link 
          href="#home" 
          className="w-10 h-10 bg-primary text-black rounded-full flex items-center justify-center shadow-lg hover:bg-primary/90 hover:scale-110 transition-all"
        >
